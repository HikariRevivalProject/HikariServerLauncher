...
- 便于删库跑路。
## How to Use? 如何使用？
1. Download the latest version of Hikari Server Launcher from [Releases](https://github.com/Hikari-Server/Hikari-Server-Launcher/releases/latest)
2. Urun HikariServerLauncher.exe
3. Follow the instructions on the screen to install the server.
4. Enjoy!
1. 从 [Releases](https://github.com/Hikari-Server/Hikari-Server-Launcher/releases/latest) 中下载最新版本的 Hikari Server Launcher 
